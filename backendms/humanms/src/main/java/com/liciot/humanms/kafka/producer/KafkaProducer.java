package com.liciot.humanms.kafka.producer;
...
public class KafkaProducer {
   //org.apache.kafka.clients.producer.KafkaProducer<String,String> producer;
    ...
    public void produceRecord(String topic, String recordValue)
    {
       ...
       //specialSystem.out.println("Partitions ready");
        ...
        public void onCompletion(RecordMetadata metadata, Exception exception) {
                ...
                try {
                    //specialSystem.out.println("[KafkaProducer.produceRecord] Callback: metadata: " + ((metadata!=null)?metadata.topic():null) + " exception: " +( (exception!=null)?exception.getMessage():null));
                }
                catch (Exception e)
                {
                    e.printStackTrace();
